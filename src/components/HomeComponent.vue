<template>
    <header class="relative" role="banner">
        <div class="w-full py-4 flex justify-between items-center text-black sticky bg-white bg-opacity-75">
            <div>
                <RouterLink to="/" aria-label="Back to homepage" class="flex items-center">
    ...
    <!-- Bonus Sale Section -->
    <section class="flex justify-center items-center h-ful p-4 md:p-24 md:justify-end relative text-black monospace" id="home">
        <img :src="`${backLink}/images/bg.png`" class="absolute top-0 left-0 z-0 h-full w-full object-cover" alt="Background Image" />
            ...
            <div>
                ...
                <div>
                    <button class="px-5 py-3 rounded-md bg-gray-900 text-white border border-gray-600"
                        aria-label="Shop Now" @click="showLogin = true">
                        Log in
                    </button>
                </div>
            </div>
    ...
    <section class="mt-12 py-6 sm:py-12 monospace" id="about">
        <div class="text-center text-4xl font-semibold mb-8">Why Shop With Us?</div>
        <div class="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0">
            <div class="bg-gray-700 w-72 h-72 rounded-md p-4 m-4 flex flex-col items-center justify-center text-white">
                <div class="text-6xl mb-4">
                    <Car />
                </div>
                <div class="text-xl font-semibold">Fast Delivery</div>
                <p class="text-center mt-2">We ensure a speedy delivery for every purchase.</p>
            </div>
            <div class="bg-gray-700 w-72 h-72 rounded-md p-4 m-4 flex flex-col items-center justify-center text-white">
                <div class="text-6xl mb-4">
                    <Ship />
            ...
            <div class="bg-gray-700 w-72 h-72 rounded-md p-4 m-4 flex flex-col items-center justify-center text-white">
                ...
                <p class="text-center mt-2">We offer products of the highest quality.</p>
            </div>
        </div>
    </section>
    ...
    <section class="mt-12 py-6 sm:py-12 monospace" id="products">
        <div class="flex justify-center">
            <h2 class="text-6xl tracking-normal font-bold text-center">
                Our
            </h2>
            <p class="text-6xl tracking-normal font-bold text-center px-2 text-red-500">products</p>
        </div>
        <div class="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0">
            <div
                class="relative bg-gray-700 w-72 h-72 rounded-md m-4 flex flex-col items-center justify-center text-white group">
                <div class="flex flex-col items-center justify-center group-hover:blur-sm transition-all duration-300">
                    <img :src="`${backLink}/images/men.jpg`" class="w-72 h-72 rounded-md" alt="">
                ...
                <div
                    ...
                    <button class="bg-red-500 p-2 rounded-md" @click="showLogin = true">SIGN IN</button>
                </div>
            </div>
            <div
                class="relative bg-gray-700 w-72 h-72 rounded-md m-4 flex flex-col items-center justify-center text-white group">
                <div
                    ...
                    <img :src="`${backLink}/images/women.jpg`" class="w-full h-full object-cover rounded-md" alt="">
            ...
            <div
                class="relative bg-gray-700 w-72 h-72 rounded-md m-4 flex flex-col items-center justify-center text-white group">
                <div class="flex flex-col items-center justify-center group-hover:blur-sm transition-all duration-300">
                    <img :src="`${backLink}/images/kid.jpg`" class="w-72 h-72 object-cover rounded-md" alt="">
    ...
    <!-- Login Component -->
    <LoginComponent v-if="showLogin" @closeTemplate="closeTemplate" @openRegistration="openRegistration"
