<template>
    ...
    <section class="h-full flex items-center justify-center bg-gray-900">
        <div class="flex justify-center m-4">
            <div class="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-white dark:text-gray-800 rounded-md max-h-[550px] overflow-y-auto">
                ...
                <div class="flex flex-col-reverse sm:flex-row justify-end sm:space-x-4">
                    <button type="button" @click="router.push('/buyerHomepage')"
                        class="m-2 md:px-6 md:py-2 border rounded-md border-violet-600">Back</button>
                    <button type="button" @click="continueToCheckout"
                        class="m-2 md:px-6 md:py-2 border rounded-md bg-violet-600 dark:text-gray-50 border-violet-600">Continue
                        to Checkout
                    </button>
                </div>
            </div>
